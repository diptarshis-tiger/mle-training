...
cols_add = [
    i for i in housing_prepared.columns if i not in X_test_prepared.columns
]
...
cols_remove = [
    i for i in X_test_prepared.columns if i not in housing_prepared.columns
]
...
# autoflake --remove-all-unused-imports --inplace --recursive .
